...
```bash
kubectl create secret generic controller-manager -n actions --from-literal=github_app_id=298877 --from-literal=github_app_installation_id=34679976 --from-file=github_app_private_key=k8s-actions-cloudbyte.2023-02-27.private-key.pem
```
